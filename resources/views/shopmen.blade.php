...
<section class="shop-section container my-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <ul class="nav nav-tabs" id="categoryTabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ url('shopmen') }}" data-category="men">Men</a>
            </li>
            <li class="nav-item">
    ...
    <div class="row g-4" id="product-grid">
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="m" data-price="85000">
            <div class="card">
                <a href="/shop2">
                <img src="{{ asset('images\Barang_Branded\Male\Top_s\Adidas Rekive Track Jacket.jpg') }}" class="card-img-top" alt="Product Image">
                </a>
                <div class="card-body">
        ...
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="l" data-price="185000">
            <div class="card">
                <img src="{{ asset('images\Barang_Branded\Male\Top_s\Uniqlo Cotton Crew Neck Long Sleeved.jpg') }}" class="card-img-top" alt="Product Image">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="s" data-price="175000">
            <div class="card">
                <img src="{{ asset('images\Barang_Branded\Male\Top_s\Nike Grey Long Sleeve.jpg') }}" class="card-img-top" alt="Product Image">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="s" data-price="85000">
            <div class="card">
                <img src="{{ asset('images\Barang_Branded\Male\Top_s\Uniqlo Flannel shirt.jpeg') }}" class="card-img-top" alt="Product Image">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="product-size">Size S</p>
                        <img src="{{ asset('images/Icon_Gambar/Semua_Icon/love.png') }}" class="wishlist-icon" alt="Wishlist Icon" style="width: 24px; height: 24px;">
        ...
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="bottoms" data-size="xl" data-price="185000">
            <div class="card">
                <img src="{{ asset('images\Barang_Branded\Male\Bottom_s\Nike Performance Sports shorts.jpg') }}" class="card-img-top" alt="Product Image">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="bottoms" data-size="m" data-price="175000">
            <div class="card">
                <img src="{{ asset('images\Barang_Branded\Male\Bottom_s\Nike SB Kearny Cargo Pants.jpg') }}" class="card-img-top" alt="Product Image">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="product-size">Size M</p>
                        <img src="{{ asset('images/Icon_Gambar/Semua_Icon/love.png') }}" class="wishlist-icon" alt="Wishlist Icon" style="width: 24px; height: 24px;">
        ...
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="bottoms" data-size="xl" data-price="85000">
            <div class="card">
                <img src="{{ asset('images\Barang_Branded\Male\Top_s\Levi_s Vintage Wellthread Jacket.jpg') }}" class="card-img-top" alt="Product Image">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <p class="product-size">Size XL</p>
                        <img src="{{ asset('images/Icon_Gambar/Semua_Icon/love.png') }}" class="wishlist-icon" alt="Wishlist Icon" style="width: 24px; height: 24px;">
        ...
        <div class="col-12 col-sm-6 col-md-3 product-card" data-category="footwear" data-size="onesize" data-price="185000">
            <div class="card">
                <img src="{{ asset('images\Barang_Branded\Female\Shoes\Nike Dunk Low.jpg') }}" class="card-img-top" alt="Product Image">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
