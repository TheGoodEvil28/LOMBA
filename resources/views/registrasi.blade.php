                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/') }}" method="GET">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control custom-input" id="name" name="name" placeholder="Name">
                        </div>
                        ...
                        <div class="d-grid">
                            <a href="{{ url('/homepage') }}" class="btn btn-dark btn-block">Register</a>
                        </div>

                        <div class="text-center mt-3">
                            <p>Already have a ReWard Account? <a href="{{ url('/masuk') }}" class="register-link">Sign In</a></p>
                        </div>
                    </form>
                </div>
            </div>
