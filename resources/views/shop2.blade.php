...
<section class="shop-section container my-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="/shopwomen">Women</a></li>
        ...
        <div id="product-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{ asset('images/Barang_Branded/Female/Top_s/Zara Floral Cotton Blouse.jpg') }}" class="d-block w-100" alt="Product Image">
                </div>
...
<div class="row g-4" id="product-grid">
    ...
    <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="l" data-price="185000">
        <div class="card">
            <a href="/shop2">
                <img src="{{ asset('images\Barang_Branded\Female\Top_s\PULL&BEAR Pullover Sweater.jpg') }}" class="card-img-top" alt="Product Image">
            </a>
            <div class="card-body">
    ...
    <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="l" data-price="185000">
        <div class="card">
            <a href="/shop2">
                <img src="{{ asset('images\Barang_Branded\Female\Top_s\Nike Sportswear Slim Crop.jpg') }}" class="card-img-top" alt="Product Image">
            </a>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="product-size">Size L</p>
    ...
    <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="l" data-price="185000">
        <div class="card">
            <a href="/shop2">
                <img src="{{ asset('images\Barang_Branded\Female\Shoes\GUCCI  Horsebit Loafers.jpg') }}" class="card-img-top" alt="Product Image">
            </a>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="product-size">Size L</p>
    ...
    <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="l" data-price="185000">
        <div class="card">
            <a href="/shop2">
                <img src="{{ asset('images\Barang_Branded\Female\Shoes\Michael Kors Aurora Sneaker.jpg') }}" class="card-img-top" alt="Product Image">
            </a>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="product-size">Size L</p>
    ...
    <div class="col-12 col-sm-6 col-md-3 product-card" data-category="tops" data-size="l" data-price="185000">
        <div class="card">
            <a href="/shop2">
                <img src="{{ asset('images\Barang_Branded\Female\Shoes\Adidas Women_s Gazelle.jpg') }}" class="card-img-top" alt="Product Image">
            </a>
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="product-size">Size L</p>
