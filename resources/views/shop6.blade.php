...
<body>
    ...
    <section class="order-success-section container text-center">
        ...
        <div class="order-image">
            <img src="{{ asset('images/Icon_Gambar/Order_Sell/succesful order.png') }}" alt="Order Success Image" class="img-fluid success-image">
        </div>
        <div class="payment-method-details">
            <div class="card payment-card">
                <div class="d-flex justify-content-between align-items-center">
                    <img src="{{ asset('images/Icon_Gambar/ReWardPoint/logo_linkAja.png') }}" alt="LinkAja" class="payment-logo">
                    <span class="payment-amount">Rp 171.500</span>
                </div>
            </div>
        </div>
        <a href="/shopwomen" class="btn btn-dark btn-large">Back to Shopping</a>
    </section>
